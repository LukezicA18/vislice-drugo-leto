...
def izpis_poraza(igra):
    return f"IZGUBIL SI, geslo je bilo: {igra.geslo}" #ali namesto f: {} pustim prazno, ostalo isto, in potem napisem .format(igra.geslo)
...
def pozeni_vmesnik():
    ...
    while True:
        ...
        if trenutna_igra.zmaga():
            ...
            return #Ker želimo končati. Kot bi dali return None. Lahko tudi break
